...
processes = {
    PA('localhost', 10101): ProcessConfig(
        ...
        100,
        [
            Action(PA('localhost', 10102), 1, 1),
            Action(PA('localhost', 10103), 2, 1),
            Action(PA('localhost', 10102), 3, 1),
            Action(PA('localhost', 10102), 4, 1),
            Action(PA('localhost', 10102), 1, 1),
            Action(PA('localhost', 10103), 2, 1),
            Action(PA('localhost', 10102), 3, 1),
            Action(PA('localhost', 10102), 4, 1),
    ...
    PA('localhost', 10102): ProcessConfig(
        ...
        200,
        [
            Action(PA('localhost', 10103), 5, 1),
            Action(PA('localhost', 10101), 6, 1),
            Action(PA('localhost', 10101), 7, 1),
            Action(PA('localhost', 10101), 8, 1),
            Action(PA('localhost', 10103), 5, 1),
            Action(PA('localhost', 10101), 6, 1),
            Action(PA('localhost', 10101), 7, 1),
            Action(PA('localhost', 10101), 8, 1),
    ...
    PA('localhost', 10103): ProcessConfig(
        ...
        300,
        [
            Action(PA('localhost', 10102), 5, 1),
            Action(PA('localhost', 10101), 6, 1),
            Action(PA('localhost', 10104), 7, 1),
            Action(PA('localhost', 10104), 8, 1),
            Action(PA('localhost', 10102), 5, 1),
            Action(PA('localhost', 10101), 6, 1),
            Action(PA('localhost', 10104), 7, 1),
            Action(PA('localhost', 10104), 8, 1),
    ...
    PA('localhost', 10104): ProcessConfig(
        ...
        [
            Action(PA('localhost', 10103), 5, 1),
            Action(PA('localhost', 10103), 6, 1),
            Action(PA('localhost', 10103), 7, 1),
            Action(PA('localhost', 10103), 8, 1),
            Action(PA('localhost', 10103), 5, 1),
            Action(PA('localhost', 10103), 6, 1),
            Action(PA('localhost', 10103), 7, 1),
            Action(PA('localhost', 10103), 8, 1),
